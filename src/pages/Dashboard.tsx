              ...
              <Card className="border-border">
                <CardContent className="flex items-center gap-4 p-5">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-foreground">{data?.contributionPoints ?? 0}</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="border-border">
                <CardContent className="flex items-center gap-4 p-5">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-foreground">{data?.recentUploads?.length ?? 0}</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="border-border">
